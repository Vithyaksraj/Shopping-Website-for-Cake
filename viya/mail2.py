...
print("<center><h1>Dear Customer&nbsp&nbsp&nbsp<br>your Order was Taken</h1><br> <h2>Thank You.<br><b></b><br><br>")
pay=0
if e=='1':
    pay='Gpay'
...
<a href="home.html"><button type='submit'  style="background-color:green;color:white;text-align:right;font-size:30;"> EXIT</button></a>
</form>
</body>
''')
...
cur.execute(query,(n,b,email,c,e))
db.commit()
'''
import smtplib
